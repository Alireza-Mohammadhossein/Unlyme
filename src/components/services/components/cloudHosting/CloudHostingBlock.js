          ...
          <div className="services__cloud-hosting_site-list">
            ...
            >
              <ListItem>
                ...
                <ListItemText
                  primary= {`${availableSitesCounter} ${t('SERVICES.CLOUDHOSTING.AVAILABLESITES')}`}
                  secondary={totalSitesCounter ? `${usedSitesCounter} ${t('SERVICES.CLOUDHOSTING.USEDSITES1')} ${totalSitesCounter} ${t('SERVICES.CLOUDHOSTING.USEDSITES2')}` : null}
                />
              </ListItem>
            </List>
          </div>
