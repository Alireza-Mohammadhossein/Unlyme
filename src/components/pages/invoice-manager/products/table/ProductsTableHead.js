...
const ProductsTableHead = (props) => {
    ...
    return (
      <>
        <TableHead className='products-header'>
          <TableRow className='products-header-row'>
            <TableCell padding="checkbox" className='products-header-row-selected'>
              <Checkbox
                color="primary"
            ...
            <TableCell colSpan={4}  padding="checkbox" className='products-header-row-option'>
          ...
          {headColumns.map((headCell) => (
            <TableCell
              key={headCell.id}
              align="center"
              className='products-header-row-cell'
              // align={headCell.numeric ? 'right' : 'left'}
              // padding={headCell.disablePadding ? 'none' : 'normal'}
              // sortDirection={orderBy === headCell.id ? order : false}
            >
