...
const RecurringSettingPopup = ({ handleCloseRecurringSettingPopup }) => {
  ...
  return (
    <div className='money-recurringsettingpopup'>
      <div className='money-recurringsettingpopup-header'>
        <div className='money-recurringsettingpopup-header-title'>
          <p>Recurring setting</p>
        </div>

        <div className='money-recurringsettingpopup-header-btn'>
      ...
      <div className='money-recurringsettingpopup-list'>

        <div className='money-recurringsettingpopup-item'>
            <p className='money-recurringsettingpopup-item-title'>
              Repeat every
            </p>

            <div className='money-recurringsettingpopup-item-double'>
                <div className='money-recurringsettingpopup-item-double-container'>
                    <FormControl fullWidth>
                        <Select
                          className="money-recurringsettingpopup-item-select"
        ...
        <div className='money-recurringsettingpopup-item'>
            ...
            <div className='money-recurringsettingpopup-item-double'>
                ...
                <div className='money-recurringsettingpopup-item-double-container'>
                    <Tooltip className='money-recurringsettingpopup-item-tooltip' id='recurringsettingpopup_tooltip' title="Invoice will stop recurring after these number of cycles. For infinity, set the value to 0" arrow placement="top">
                        <IconButton>
                          <HelpOutlineIcon />
                        </IconButton>
                    </Tooltip>
        ...
        <div className='money-recurringsettingpopup-item'>
            ...
            <div className='money-recurringsettingpopup-item-double'>
                <div className='money-recurringsettingpopup-item-double-container'>
                    <div className='money-recurringsettingpopup-item-date'>
                ...
                <div className='money-recurringsettingpopup-item-double-container'>
                    <Tooltip className='money-recurringsettingpopup-item-tooltip' id='recurringsettingpopup_tooltip' title="See information below" arrow placement="top">
                        <IconButton>
                          <HelpOutlineIcon />
                        </IconButton>
                    </Tooltip>
        ...
        <div className='money-recurringsettingpopup-item'>
            <div className='money-recurringsettingpopup-item-alert'>
                {
                    firstAlert ? 
                        <Alert
        ...
        <div className='money-recurringsettingpopup-btn'>
          <Button className='money-recurringsettingpopup-btn-reset' onClick={handleCancelRecurring}>Cancel</Button>

          <Button className='money-recurringsettingpopup-btn-submit' onClick={handleSubmitRecurring}>Submit</Button>
        </div>
      </div>
