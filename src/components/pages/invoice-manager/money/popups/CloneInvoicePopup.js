    ...
    <div className='money-cloneinvoicepopup'>
      ...
      <div className='money-cloneinvoicepopup-list'>        
        <div className='money-cloneinvoicepopup-item flex'>
          ...
          <div className='money-cloneinvoicepopup-item-date'>
        ...
        <div className='money-cloneinvoicepopup-item tags'>
          <p className='money-cloneinvoicepopup-item-title'>
            Tags
          </p>
        ...
        <div className='money-cloneinvoicepopup-btn'>
          <Button className='money-cloneinvoicepopup-btn-reset' onClick={handleCancelClone}>Cancel</Button>

          <Button className='money-cloneinvoicepopup-btn-submit' onClick={handleSubmitClone}>Submit</Button>
        </div>
      </div>
