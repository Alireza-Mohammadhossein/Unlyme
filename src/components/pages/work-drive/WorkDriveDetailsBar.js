    ...
    return (
        <Grid container spacing={2}>
            <Grid item lg={3} md={6} xs={12}>
                <div className='cloud-page__header_work-drive-page-details_view-mode'>
                    <ToggleButtonGroup
                        value={viewMode}
                        exclusive
                        onChange={handleViewMode}
                        aria-label="text alignment"
                        className='cloud-page__header_work-drive-page-details_view-mode_toggler'
                    >
            ...
            <Grid item lg={3} md={6} xs={12}>
                <div className='cloud-page__header_work-drive-page-details_format'>
            ...
            <Grid item lg={3} md={6} xs={12}>
                <div className='cloud-page__header_work-drive-page-details_actions'>
