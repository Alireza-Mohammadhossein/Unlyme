...
function TabPanel(props) {
  ...
  const WorkDriveContent = ({searchNote, setSearchNote}) => {
              ...
              <div className="work-drive-page_sidebar-section">
                ...
                >
                  {filteredNote.map((item, index) => (
                    <Tab
                      className="work-drive-page_sidebar-section_notes-item"
                      key={item.id}
                      {...a11yProps(index)}
                      component={"div"}
                      label={
                        <>
                          <div className="work-drive-page_sidebar-section_notes-item_content">
                            <p className="work-drive-page_sidebar-section_notes-item_content_name">
                              {item.title}
                            </p>
                            <p className="work-drive-page_sidebar-section_notes-item_content_message">
                              {item.message}
                            </p>
                          </div>
  
                          <div className="work-drive-page_sidebar-section_notes-item_actions">
                            <div className="work-drive-page_sidebar-section_notes-item_actions-delete">
                              <IconButton
                                aria-label="delete"
                                id="long-button"
          ...
          >
            <div className="work-drive-page_main">
              <div className="work-drive-page_main_notes">
                ...
                {showNote !== false
                  ? 
                  <div className='work-drive-page_main_notes-messages'>
                    {notes.map((item, index) => {
                      return (
                        <TabPanel key={item.id} value={showNote} index={index} className='work-drive-page_main_notes-messages-tabpanel'>
                            <div className='work-drive-page_main_notes-messages__body'>
  
                              <div className='work-drive-page_main_notes-messages__body-date'>
                                <p>{item.day} {item.month} {item.year} at {item.time}</p>
                              </div>
  
                              <div className='work-drive-page_main_notes-messages__body-content'>
                                  <TextField
                                    className='work-drive-page_main_notes-messages__body-content-title'
                                  ...
                                  <TextField
                                    className='work-drive-page_main_notes-messages__body-content-message'
                              ...
                              <div className='work-drive-page_main_notes-messages__body-submit'>
                                <button
                                  className='btn'
